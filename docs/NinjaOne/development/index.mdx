...
Tests run with Pester 6.x. By default, `test.ps1` runs the selected Pester suites and then performs a direct `Invoke-ScriptAnalyzer` pass against the module under test.
